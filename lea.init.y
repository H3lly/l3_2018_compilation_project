...
TOKEN_PRINT TOKEN_PRINTLN TOKEN_PROCEDURE TOKEN_TYPE TOKEN_BOOLEAN TOKEN_INTEGER
TOKEN_RETURN TOKEN_TRUE TOKEN_VAR TOKEN_WHILE IDENTIFIER CHARACTER INTEGER*/

%token '!' '(' ')' '*' '+' ',' '-' '/' ':' ';' '<' '=' '>' '[' ']' '^'
TOKEN_AFF TOKEN_AND TOKEN_ARRAY TOKEN_BEGIN TOKEN_CHARACTER TOKEN_DISPOSE
TOKEN_DO TOKEN_DOTDOT TOKEN_ELSE TOKEN_END TOKEN_FALSE TOKEN_FUNCTION TOKEN_GE
TOKEN_IF TOKEN_LE TOKEN_NEW TOKEN_NE TOKEN_NULL TOKEN_OF TOKEN_OR TOKEN_PRINT
TOKEN_PRINTLN TOKEN_PROCEDURE TOKEN_THEN TOKEN_TYPE TOKEN_BOOLEAN TOKEN_INTEGER
TOKEN_RETURN TOKEN_TRUE TOKEN_VAR TOKEN_WHILE IDENTIFIER CHARACTER INTEGER
